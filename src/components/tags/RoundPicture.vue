...
const tagType = ETagType.RoundPicture;
  ...
  <div class="tag-item" ref="tagItem">
    <div class="group" :style="{
      ...
      <div class="tag" :style="{
        ...
        <div class="text-region" ref="stringContainer" :style="{
    ...
    <div class="tag-description" :style="{ marginLeft: '25px' }">
      <p class="tag-title m-0">Redonda Com Foto</p>
...
.tag {
  ...
  -webkit-mask-image: radial-gradient(circle 18px at 3.5cm 0.75cm, black 49%, black 50%);
  mask-image: radial-gradient(circle 18px at 3.5cm 0.75cm, black 49%, black 50%);
  white-space: nowrap;
  display: grid;
  border-radius: 50%;
