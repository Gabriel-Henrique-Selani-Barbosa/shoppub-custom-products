...
const tagType = ETagType.RectangularMediumPicture;
...
<template>
  <div class="tag-item" ref="tagItem">
    <div class="group" ref="stringContainer" :style="{
      ...
      <div class="tag tag-square" :style="{
    ...
    <div class="tag-description" :style="{ marginLeft: '25px' }">
      <p class="tag-title m-0">Etiqueta Média Com Foto</p>
