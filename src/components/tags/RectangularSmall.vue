...
const tagType = ETagType.RectangularSmall;
...
<template>
  <div class="tag-item" ref="tagItem">
    <div class="small-tag" ref="stringContainer" :style="{
      marginTop: '20px',
      marginLeft: '25px',
      position: 'relative',
      ...
      <div ref="container_stringSpan_1" :style="{
        ...
        <span class="small-tag-text string-container" ref="stringSpan_1" :style="{
    ...
    <div class="tag-description" :style="{ marginLeft: '25px' }">
      <p class="tag-title m-0">Etiqueta Pequena</p>
