...
const tagType = ETagType.RectangularBirthday;
  ...
  <div class="tag-item" ref="tagItem">
    <div class="tag" ref="stringContainer" :style="{
      ...
      <div :style="{ textAlign: 'center', marginBottom: '6px' }">
        <span class="tag-text-title" :style="{
    ...
    <div class="tag-description" :style="{ marginLeft: '25px' }">
      <p class="tag-title m-0">Etiqueta Retangular Para Aniversário</p>
