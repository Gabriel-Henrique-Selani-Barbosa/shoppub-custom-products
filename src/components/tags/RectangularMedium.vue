...
const height = props.height || 1.3;
const tagType = ETagType.RectangularMedium;
...
<template>
  <div class="tag-item" ref="tagItem">
    <div class="tag" ref="stringContainer" :style="{
      ...
      <div :style="{ width: `${width * scaleFactor}cm`, display: 'flex' }">
        <div :style="{
          width: '100%',
          alignSelf: 'center',
          display: 'grid',
          paddingLeft: hasImage ? '4rem' : 0,
        }">
          <div ref="container_stringSpan_1" :style="{
            ...
            <span class="tag-text string-container" ref="stringSpan_1" v-if="getText(props.field, 0, [EItemType.text])"
              :style="{
          ...
          <div ref="container_stringSpan_2" :style="{
            ...
            <span class="tag-text string-container" ref="stringSpan_2" v-if="getText(props.field, 1, [EItemType.text])"
              :style="{
                color: getTextColor(props.field),
                textShadow: `${textShadow(
                  builder,
    ...
    <div class="tag-description" :style="{ marginLeft: '25px' }">
      <p class="tag-title m-0">Etiqueta Média</p>
