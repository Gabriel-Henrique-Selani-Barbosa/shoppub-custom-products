...
const tagType = ETagType.RoundTagPicture;
  ...
  <div class="tag-item" ref="tagItem">
    <div class="group">
      ...
      <div class="tag reverse-hole" :style="{
        marginTop: `${20}px`,
        maskImage: `radial-gradient(circle ${18 * scaleFactor}px at ${3.5 * scaleFactor}cm ${0.75 * scaleFactor}cm, transparent 49%, white 50%)`,
        position: 'relative',
    ...
    <div class="tag-description" :style="{ marginLeft: '25px' }">
      <p class="tag-title m-0">Etiqueta Redonda Com Foto</p>
